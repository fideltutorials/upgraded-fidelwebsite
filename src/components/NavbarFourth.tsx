...
export default function NavbarFourth() {
  ...
  return (
    <>
        ...
        <div className="max-w-[1200px] mx-auto px-6 h-20 flex items-center justify-between relative">
          ...
          >
            ...
            <span className="flex flex-col leading-none">
              <span className="font-serif font-semibold text-base text-brand-ink">
                Fidel Tutorial
              </span>
              <span className="font-sans text-[9px] uppercase tracking-widest text-brand-primary font-bold mt-1">
                Enterprise Standard
              </span>
            </span>
          </a>
          ...
          <nav className="hidden lg:flex items-center gap-2">
            <ul className="flex items-center gap-2" role="menubar">
              <li onMouseEnter={() => setOpenMega(null)}>
                <a
                  href="/"
                  className="px-4 py-2 rounded-lg text-sm font-semibold text-brand-ink hover:bg-brand-cream-warm transition-colors"
                >
                  Home
                </a>
              </li>
              ...
              >
                <a
                  href="/programs"
                  className={`px-4 py-2 rounded-lg text-sm font-semibold text-brand-ink hover:bg-brand-cream-warm transition-colors flex items-center gap-1.5 ${
                    openMega === "programs"
                      ? "bg-brand-cream-warm text-brand-primary"
                      : ""
                  }`}
                >
                  Programs
          ...
          >
            <a
              ...
              className={cn(
                ...
                "hidden lg:inline-flex rounded-full text-xs font-bold px-5 py-3 shadow-md",
              )}
            >
              Book a Free Trial
            </a>
          ...
          <div
            className={`absolute left-0 right-0 top-full bg-brand-paper border-b border-brand-rule shadow-2xl transition-all duration-300 ${
              openMega === "programs"
            ...
            <div className="max-w-[1200px] mx-auto px-6 py-8 grid grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-center gap-2.5 mb-2.5">
                  ...
                  <span className="text-xs font-bold text-brand-ink group-hover:text-brand-primary transition-colors">
                    One-on-One Tutoring
                  </span>
                </div>
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Vetted personal matching and diagnostic skills alignment for
                  KG to University.
                </span>
              </a>
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Grade 6, 8, and 12 EHEECE national mock exam prep cycles under
                  real timed setups.
                </span>
              </a>
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Interactive mock testing database, skills diagnostic audit,
                  and live strategy sessions.
                </span>
              </a>
            </div>
          </div>
          ...
          >
            <div className="max-w-[1200px] mx-auto px-6 py-8 grid grid-cols-4 gap-6">
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Staff audits, curriculum mapping, and teacher training blocks
                  for private schools.
                </span>
              </a>
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  White-labeled learning management software licensed to private
                  academies.
                </span>
              </a>
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Non-profit accelerated reading clinics and educational aid
                  partnerships.
                </span>
              </a>
              ...
              >
                ...
                <span className="block text-[10.5px] text-brand-muted leading-relaxed">
                  Fund and manage high-quality local packages back home securely
                  in USD.
                </span>
              </a>
            </div>
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed inset-0 z-50 bg-brand-ink/40 backdrop-blur-sm lg:hidden transition-opacity duration-300 ${
          mobileOpen
            ? "opacity-100 visible"
      ...
      >
        <div
          className={`absolute top-0 right-0 bottom-0 w-[85vw] max-w-[340px] bg-brand-paper shadow-2xl flex flex-col overflow-hidden transition-transform duration-300 ${
            ...
            <ul className="flex flex-col gap-4">
                  ...
                  {mobileProgramsOpen && (
                    <div className="p-3 bg-brand-cream-warm/5 border-t border-brand-rule/40 flex flex-col gap-2.5 animate-in slide-in-from-top-2 duration-200">
                      ...
                      >
                        ...
                        <span className="text-[11px] text-brand-muted mt-0.5">
                          Grade 6, 8, and 12 mock preparation cycles.
                        </span>
                      </a>
                      <a
                        href="/programs/test-prep"
                      ...
                      >
                        ...
                        <span className="text-[11px] text-brand-muted mt-0.5">
                          Mock testing database and live feedback sessions.
                        </span>
                      </a>
                    </div>
                  )}
                  ...
                  {mobileSchoolsOpen && (
                    <div className="p-3 bg-brand-cream-warm/5 border-t border-brand-rule/40 flex flex-col gap-2.5 animate-in slide-in-from-top-2 duration-200">
                      ...
                      >
                        ...
                        <span className="text-[11px] text-brand-muted mt-0.5">
                          Staff development audits & teacher training cycles.
                        </span>
                      </a>
                      <a
                        href="/schools/lms-licensing"
                      ...
                      >
                        ...
                        <span className="text-[11px] text-brand-muted mt-0.5">
                          Non-profit accelerated reading cycles in Addis.
                        </span>
                      </a>
                      <a
                        href="/diaspora"
                      ...
                      >
                        ...
                        <span className="text-[11px] text-brand-muted mt-0.5">
                          Fund relatives' private packages back home securely in
                          USD.
                        </span>
                      </a>
                    </div>
              ...
              <li>
                <a
                  href="/resources"
                  onClick={() => setMobileOpen(false)}
                  className="flex px-3 py-2.5 rounded-xl text-sm font-semibold text-brand-ink hover:bg-brand-cream-warm/40 transition-colors"
                >
                  Resources
                </a>
              </li>
