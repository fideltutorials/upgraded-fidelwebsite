      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-2xl mb-12">
          ...
          <p className="text-brand-muted text-base leading-relaxed mt-4">
            Whether you are a parent in Bole, a head of school in Lebu, an aunt in
            Washington, or a programme officer at a donor, we have built a way to
            work with you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <div className="bg-brand-paper border border-brand-rule rounded-xl p-8 flex flex-col gap-4 hover:border-brand-secondary hover:shadow-xl hover:shadow-brand-primary/5 transition-all duration-200">
            ...
            <a
              href="/programs"
              className="text-xs font-bold text-brand-primary hover:text-brand-primary-deep inline-flex items-center gap-0.5 mt-2"
            >
              Explore programs →
            </a>
          </div>
