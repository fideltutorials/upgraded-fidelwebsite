...
import NavbarSixth from "@/components/NavbarSixth";
import Footer from "@/components/Footer";

interface LayoutProps {
  title?: string;
  description?: string;
  navVersion?: "default" | "pill" | "mega" | "list";
...
export default function Layout({
  ...
  return (
    <div className="bg-brand-paper text-brand-ink selection:bg-brand-secondary selection:text-brand-ink min-h-screen flex flex-col font-sans antialiased overflow-x-hidden">
      {navVersion === "pill" && <NavbarSecond />}
      {navVersion === "mega" && <NavbarFourth />}
      {navVersion === "default" && <Navbar />}
      {navVersion === "list" && <NavbarSixth />}
